...
class PerformanceTrackingRewriterSpec {
  ...
  @Test
  void "should copy the content of input jar file to output jar file with transformation"() {
  ...
  @Test
  void "should rewrite AppPerformanceConfig class, set enable value to true and add to output JAR"() {
