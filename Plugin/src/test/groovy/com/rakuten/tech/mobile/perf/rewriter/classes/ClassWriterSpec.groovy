...
class ClassWriterSpec {
  ...
  @Test
  void "should provide common super class for given sub classes"() {
  ...
  @Test
  void "should provide object class as super class when any one input parameter is interface"() {
    String type1 = "jp.co.rakuten.api.rae.engine.TokenRequest"
  ...
  @Test
  void "should provide same super type even by swapping input parameter"() {
  ...
  void "should fail to get common super type when given class not found"() {
    String type1 = "test"
    String type2 = "test"
